...
# Broadcasting
Julia has a powerful feature called broadcasting, which allows you to apply functions element-wise to arrays and other collections. You can use the `.` operator to broadcast a function over an array.
